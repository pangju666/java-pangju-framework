 ...
 * 雪花ID和逻辑删除基础实体类
 * <p>
 * 基于{@link LogicBasicEntity}，使用雪花ID作为主键ID。
 * 适用于需要雪花ID主键和完整逻辑删除功能的实体类。
 * </p>
 *
 * @author pangju666
 * @since 1.0.0
 */
public abstract class SnowflakeIDLogicBasicEntity extends LogicBasicEntity<String> implements SnowflakeId {
	/**
	 * 雪花算法主键ID
	 *
	 * @since 1.0.0
