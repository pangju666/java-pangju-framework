 ...
 * <p>
 * 基于{@link VersionLogicTimeBasicEntity}，使用雪花ID作为主键ID。
 ...
 * @since 1.0.0
 */
public abstract class SnowflakeIDVersionLogicTimeBasicEntity extends VersionLogicTimeBasicEntity implements SnowflakeId {
	/**
	 * 雪花算法主键ID
	 *
	 * @since 1.0.0
