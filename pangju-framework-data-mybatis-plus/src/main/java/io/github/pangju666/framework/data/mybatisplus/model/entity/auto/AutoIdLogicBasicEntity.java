 ...
 * 自增ID和逻辑删除基础实体类
 * <p>
 * 基于{@link LogicBasicEntity}，使用自增ID作为主键ID。
 * 适用于需要自增主键和完整逻辑删除功能的实体类。
 * </p>
 *
 * @author pangju666
 * @since 1.0.0
 */
public abstract class AutoIdLogicBasicEntity extends LogicBasicEntity<Long> implements AutoId {
	/**
	 * 自增主键ID
	 *
	 * @since 1.0.0
