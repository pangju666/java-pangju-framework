 ...
 * 数据查询异常
 * <p>
 * 封装数据查询过程中发生的异常情况，提供结构化的错误上下文信息：
 * <ul>
 *     <li>查询条件无效：查询参数不符合业务规则或格式要求</li>
 *     <li>数据不存在：根据指定条件未找到匹配的数据记录</li>
 *     <li>查询执行失败：数据库查询操作执行过程中发生错误</li>
 *     <li>权限不足：没有足够权限查询请求的数据</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <pre>{@code
 * // 基本用法
 * throw new DataQueryException("数据记录不存在");
 *
 * // 使用错误数据对象
 ...
 *     "订单记录不存在"     // 错误原因
 * );
 * throw new DataQueryException("查询订单失败", error);
 * }</pre>
 * </p>
 *
 * @author pangju666
...
public class DataQueryException extends DataOperationException {
	 ...
	 * @since 1.0.0
	 */
	protected static final String DEFAULT_ERROR_MESSAGE = "数据查询错误";
	/**
	 * 操作类型常量
	 * <p>
	 * 标识此异常对应的固定操作类型为"查询"。
	 ...
	 * @since 1.0.0
	 */
	protected static final String OPERATION = "查询";
